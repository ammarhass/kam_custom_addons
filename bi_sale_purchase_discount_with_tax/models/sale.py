...
class sale_order(models.Model):
	...
	total_amount_before_discount_amt = fields.Monetary(compute='_compute_total_amount_before_discount_amt', string='Amount Before Discount', store=True, readonly=True)
