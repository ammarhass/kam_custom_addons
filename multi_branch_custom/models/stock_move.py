...
class StockMove(models.Model):
    ...
    def _get_accounting_data_for_valuation(self):
        ...
        accounts_data = self.product_id.product_tmpl_id.with_context(branch_id=self.picking_id.purchase_id.branch_id or self.picking_id.sale_id.branch_id).get_product_accounts()
